...
with hive.connect(host='localhost', port=10000, configuration={'hive.stats.autogather': 'false'}) as connection, connection.cursor() as cursor:
    ...
    setup_table("WDIData_2017", "country_name STRING, indicator_code STRING, y2016 DOUBLE, y2017 DOUBLE, y2018 DOUBLE, y2019 DOUBLE, y2020 DOUBLE, y2021 DOUBLE, y2022 DOUBLE", remove_header=True)
