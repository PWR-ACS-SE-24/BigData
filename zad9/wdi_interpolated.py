...
with connect_to_hive() as cursor:
    setup_output_table(
        cursor,
        "wdi_interpolated",
        "country STRING, date_ DATE, rural_population_percent DOUBLE, fertility_rate DOUBLE, gdp_per_capita_usd DOUBLE, mobile_subscriptions_per_100 DOUBLE, refugee_population_promille DOUBLE",
    )
    ...
    preview_table(cursor, "wdi_interpolated")
